...
def visualize_rand_forest_polar(adata, train_or_test = 'test'):
...
def visualize_rand_forest_cartesian(adata, train_or_test = 'test'):
...
def visualize_rand_forest(adata, train_or_test = 'test'):
    ...
    if coord == 'polar':
        visualize_rand_forest_polar(adata, train_or_test = train_or_test)
    
    elif coord == 'cartesian':
        visualize_rand_forest_cartesian(adata, train_or_test = train_or_test)
