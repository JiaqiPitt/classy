...
def visualize_gp_polar(adata, train_or_test = 'test'):
    ...
    classifier = adata.uns['gp_result']['Classifier']
...
def visualize_gp_cartesian(adata, train_or_test = 'test'):
...
def visualize_gp(adata, train_or_test = 'test'):
    ...
    if coord == 'polar':
        visualize_gp_polar(adata, train_or_test = train_or_test)
    
    elif coord == 'cartesian':
        visualize_gp_cartesian(adata, train_or_test = train_or_test)
